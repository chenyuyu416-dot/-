...
export const Gamepad2: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const Trophy: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M6 9H4.5a2.5 2.5 0 0 1 0-5H6"/><path d="M18 9h1.5a2.5 2.5 0 0 0 0-5H18"/><path d="M4 22h16"/><path d="M10 14.66V22h4v-7.34"/><path d="M7 10h10"/><path d="M12 10V5.42c0-.6.45-1.09 1.05-.98l2.1.34a1 1 0 0 0 1.05-.98V4c0-.55-.45-1-1-1H9.8c-.55 0-1 .45-1 1v.78c0 .6.45 1.09 1.05.98l2.1-.34a1 1 0 0 1 1.05.98V10"/></svg>
);

export const Library: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M16 6h3v12h-3"/><path d="M12 6h4v12h-4"/><path d="M8 6h4v12H8"/><path d="M4 6h4v12H4"/></svg>
);
...
export const PencilRuler: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M15 5l4 4"/><path d="M13 7L8.7 2.7a2.41 2.41 0 0 0-3.4 0L2.7 5.3a2.41 2.41 0 0 0 0 3.4L7 13"/><path d="M8 12l5 5"/><path d="M22 17l-1.4-1.4"/><path d="M16 11l-1.4-1.4"/><path d="M21 12h-5l-1.1-1.1"/><path d="m19 14-1-1"/><path d="M14 19l-3 3H3v-8l3-3"/></svg>
);
...
export const Brush: React.FC<IconProps> = ({ className }) => (
...
export const PhoneOff: React.FC<IconProps> = ({ className }) => (
...
export const VideoOff: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M16 16v1a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2h2m5.66 0H14a2 2 0 0 1 2 2v3.34l1 1L23 7v10"/><line x1="2" y1="2" x2="22" y2="22"/></svg>
);
export const MicOff: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><line x1="2" y1="2" x2="22" y2="22"/><path d="M18.89 13.23A7.12 7.12 0 0 0 19 12v-2"/><path d="M5 10v2a7 7 0 0 0 12 5"/><path d="M15 9.34V4a3 3 0 0 0-5.68-1.33"/><path d="M9 9v3a3 3 0 0 0 5.12 2.12"/><line x1="12" y1="19" x2="12" y2="23"/></svg>
);
export const ScreenShare: React.FC<IconProps> = ({ className }) => (
...
export const Wand2: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="m3 21 3.05-9.16a2.22 2.22 0 0 1 4.12 0L13.23 21"/><path d="M21 3 8.84 15.16"/><path d="M15.06 3 13.23 21"/><path d="M3 21h10"/><path d="M21 3h-1.56"/></svg>
);
