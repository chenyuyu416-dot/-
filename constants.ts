...
import { User, Chat, Category, Post, Competition, Job, VolunteerActivity, Comment, Team, TeamRequest } from './types';
...
export const DUMMY_POSTS: Post[] = [
    { id: 'p1', author: DUMMY_USERS['user1'], category: 'study', title: '找个搭子一起备战25软工考研', content: '本人目标院校是北邮，数学一英语一，希望找个作息规律、能互相监督的研友，可以一起线上自习！', tags: ['25考研', '计算机', '线上自习'], timestamp: '2小时前', likes: 12, comments: 4, image: 'https://picsum.photos/seed/post1/400/200' },
    { id: 'p2', author: DUMMY_USERS['user2'], category: 'competition', title: '互联网+大赛寻一位前端队友', content: '我们团队目前有产品和后端，项目是关于校园社交的，技术栈要求Vue/React，有项目经验的优先。', tags: ['互联网+', '前端', '组队'], timestamp: '5小时前', likes: 25, comments: 8 },
    { id: 'p3', author: DUMMY_USERS['user3'], category: 'hobby', title: '周末有人一起爬山吗？坐标香山', content: '天气这么好，一起去爬山呼吸新鲜空气吧！预计周六早上9点出发，男女不限，体力好的来！', tags: ['户外', '爬山', '周末活动'], timestamp: '昨天', likes: 30, comments: 15, image: 'https://picsum.photos/seed/post3/400/200' },
    { id: 'p4', author: DUMMY_USERS['user5'], category: 'study', title: '法考主观题冲刺，找个小伙伴互相督促', content: '每天约定时间线上会议室模拟，互相出题背诵，要求有一定基础，非诚勿扰。', tags: ['法考', '主观题', '监督'], timestamp: '3天前', likes: 8, comments: 2 },
    { id: 'p5', author: DUMMY_USERS.currentUser, category: 'hobby', title: '羽毛球爱好者求搭子，每周2-3次', content: '坐标海淀，一般在学校体育馆，水平中等，寻找一个长期固定的球友，一起锻炼，共同进步。', tags: ['羽毛球', '海淀', '长期搭子'], timestamp: '1周前', likes: 18, comments: 6, image: 'https://picsum.photos/seed/post5/400/200' },
];
...
export const DUMMY_COMPETITIONS: Competition[] = [
    { id: 'comp1', name: '第十届中国国际“互联网+”大学生创新创业大赛', category: '创业', deadline: '2024-08-31', participants: '1-15人', details: '大赛旨在深化高等教育综合改革，激发大学生的创造力，培养造就“大众创业、万众创新”的生力军...'},
    { id: 'comp2', name: '2024年全国大学生数学建模竞赛', category: '学科', deadline: '2024-09-01', participants: '3人', details: '要求三人组成一队，在三天时间内，就指定的问题完成从建立模型、求解、验证到论文撰写的全部工作。'},
    { id: 'comp3', name: '蓝桥杯全国软件和信息技术专业人才大赛', category: '技能', deadline: '2024-10-15', participants: '个人赛', details: '国内领先的全国性IT学科赛事，旨在促进软件和信息技术专业人才培养。'},
];
...
export const DUMMY_JOBS: Job[] = [
    {id: 'j1', title: '前端开发实习生', company: '字节跳动', location: '北京', type: '线下', salary: '400/天', deadline: '2024-09-30'},
    {id: 'j2', title: '产品运营实习生', company: '腾讯', location: '深圳', type: '线下', salary: '300/天', deadline: '2024-08-31'},
    {id: 'j3', title: '新媒体内容编辑', company: '小红书', location: '上海', type: '远程', salary: '200/天', deadline: '2024-10-15'},
];

export const DUMMY_VOLUNTEER_ACTIVITIES: VolunteerActivity[] = [
    {id: 'v1', title: '“爱心书屋”图书整理', organization: '北京大学青年志愿者协会', location: '校内图书馆', time: '每周六下午', required: 10, certification: true},
    {id: 'v2', title: '马拉松赛事服务志愿者', organization: '北京市体育局', location: '奥林匹克森林公园', time: '2024-10-20 全天', required: 50, certification: true},
    {id: 'v3', title: '“阳光助学”线上支教', organization: '西部阳光基金会', location: '线上', time: '每周2小时', required: 20, certification: false},
];
